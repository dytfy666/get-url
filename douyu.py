...
def get_real_url(rid):
    ...
    if url:
        return "最高清晰度：http://tx2play1.douyucdn.cn/live/" + url + ".flv?uuid=\n\n" \
               "蓝光4M:http://tx2play1.douyucdn.cn/live/" + url + "_4000p.flv?uuid=\n\n"\
               "超清:http://tx2play1.douyucdn.cn/live/" + url + "_2000p.flv?uuid=\n\n"\
               "高清:http://tx2play1.douyucdn.cn/live/" + url + "_1200p.flv?uuid="  , titlel
        ...
        if real_url != 0:
            real_url = "http://tx2play1.douyucdn.cn/live/" + real_url + ".flv?uuid=\n\n"\
                       "蓝光4M:http://tx2play1.douyucdn.cn/live/" + real_url + "_4000p.flv?uuid=\n\n" \
                       "超清:http://tx2play1.douyucdn.cn/live/" + real_url + "_2000p.flv?uuid=\n\n" \
                       "高清:http://tx2play1.douyucdn.cn/live/" + real_url + "_1200p.flv?uuid="
        else:
            real_url = '未开播'
        return real_url,titlel
